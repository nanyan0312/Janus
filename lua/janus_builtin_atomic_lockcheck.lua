...
if ("janus_builtin_atomic_lockcheck_yes" == janus_builtin_avoid_repetition_switch) then
    local janus_builtin_avoid_repetition_key_allowed_to_participate_switch = 'allowed_to_participate_switch_{' .. janus_builtin_avoid_repetition_lock_name .. '}';
    local janus_builtin_avoid_repetition_allowed_to_participate_switch = redis.call("GET", janus_builtin_avoid_repetition_key_allowed_to_participate_switch);
    if (false == janus_builtin_avoid_repetition_allowed_to_participate_switch) then 
        return {-1, "janus_builtin_atomic_lockcheck_failed, NOT allowed_to_participate_switch"}; 
    end; 
